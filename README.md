...
let var_binding = DerValue::Sequence([
  DerValue::ObjectId(oid_from_string("1.3.6.1.2.1.1.1.0").unwrap()),
  DerValue::Null
])

let snmp_pdu = DerValue::Sequence([
  DerValue::Integer(0L),
  DerValue::OctetString([b'p', b'u', b'b', b'l', b'i', b'c']),
  DerValue::ImplicitTag(0xA0,
    DerValue::Sequence([
      DerValue::Integer(1234L),
      DerValue::Integer(0L),
      DerValue::Integer(0L),
      DerValue::SequenceOf([var_binding])
    ])
  )
])
